...
<div class="form-group">
    ...
    <input type="date" class="form-control" name="generated_bill"  id="generated_bill" value="{{ old('generated_bill' )}}">
...
<div class="form-group">
    ...
    <input type="date" class="form-control"  name="delivered_bill"  id="delivered_bill" value="{{ old('delivered_bill')}}">
